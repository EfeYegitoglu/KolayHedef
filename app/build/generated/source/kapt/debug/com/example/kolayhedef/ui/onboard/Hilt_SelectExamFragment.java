...
public abstract class Hilt_SelectExamFragment<VB extends ViewBinding, VM extends BaseViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectExamFragment_GeneratedInjector) this.generatedComponent()).injectSelectExamFragment(UnsafeCasts.<SelectExamFragment>unsafeCast(this));
    }
  }
