...
public abstract class Hilt_AccountInfoFragment<VB extends ViewBinding, VM extends BaseViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountInfoFragment_GeneratedInjector) this.generatedComponent()).injectAccountInfoFragment(UnsafeCasts.<AccountInfoFragment>unsafeCast(this));
    }
  }
