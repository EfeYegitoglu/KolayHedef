...
public abstract class Hilt_SelectDateFragment<VB extends ViewBinding, VM extends BaseViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectDateFragment_GeneratedInjector) this.generatedComponent()).injectSelectDateFragment(UnsafeCasts.<SelectDateFragment>unsafeCast(this));
    }
  }
