...
public abstract class Hilt_SelectTimeFragment<VB extends ViewBinding, VM extends BaseViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectTimeFragment_GeneratedInjector) this.generatedComponent()).injectSelectTimeFragment(UnsafeCasts.<SelectTimeFragment>unsafeCast(this));
    }
  }
